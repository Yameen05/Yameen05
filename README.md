...
class Yameen(Person):
    def __init__(self):
        ...
        self.alive = True  # still grinding
        self.interests = [
            "Backend Systems",
    ...
    def languages(self):
        return {
            "programming": ["Java", "Python", "TypeScript", "JavaScript", "SQL"],
    ...
    def currently(self):
        return {
            "building": [
                "Full-stack apps with real use cases",
                "AI-powered backend services",
                "Projects worth putting on a resume"
            ],
            "learning": [
                "AWS",
                "System design",
                "How to not embarrass myself on LeetCode"
            ]
        }
```
